...
' #txt
Ps0 f6 actionCode 'import com.axonivy.utils.persistence.demo.ui.PersonSearchBean;
...
>Proto Ps0 .type com.axonivy.utils.persistence.demo.PersonSearch.PersonSearchData #txt
